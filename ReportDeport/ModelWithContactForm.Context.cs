...
namespace ReportDeport
{
    ...
    public partial class ReportDepotEntities2 : DbContext
    {
        public ReportDepotEntities2()
            : base("name=ReportDepotEntities2")
        {
        }
        ...
        public virtual DbSet<Magwinya> Magwinyas { get; set; }
